  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">{{ $WebsiteInfo['email'] }}</a>
        <i class="bi bi-phone"></i> {{ $WebsiteInfo['phone'] }}
      </div>
      <div class="d-none d-lg-flex social-links align-items-center">
        ...
        @if(auth()->user()->role_id == 1)
          <a href="{{ route('admin.index') }}"  class="">Go to dashboard</a>
        @endif
      </div>
    </div>
  </div>
  ...
  <main id="main">
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form action="{{ route('admin.appointment.store') }}" method="post" role="form" >
          @csrf
          <div class="row">
            <div class="col-md-4 form-group mt-3">
              <input type="tel" class="form-control" name="phone" id="phone" placeholder="Your Phone" data-rule="minlen:4" data-msg="Please enter phone number">
              @error('phone')
        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              @foreach ($categories as $category)
                <li class="nav-item">
                <a class="nav-link @if($loop->iteration==1)active show @endif" data-bs-toggle="tab" href="#{{ $category->name }}">{{ $category->name }}</a>
              </li>
              @endforeach
            </ul>
          </div>
          <div class="col-lg-9 mt-4 mt-lg-0">
            <div class="tab-content">
              @foreach ($categories as $category)
                <div class="tab-pane @if($loop->iteration==1)active show @endif" id="{{ $category->name }}">
                  <div class="row">
          ...
          @foreach ($doctors as $doctor)
            <div class="col-lg-6 mt-4">
              <div class="member d-flex align-items-start">
                <div class="pic"><img src="{{asset('uploads/doctor/'.$doctor->image)}}" class="img-fluid" alt=""></div>
      ...
      <div class="container">
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="{{ route('admin.message.store') }}" method="post" role="form">
              @csrf
              <div class="row">
              <div class="form-group mt-3">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form action="{{ route('admin.subscribe.mail.store') }}" method="POST">
              @csrf
